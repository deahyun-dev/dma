...
int XAxiDma_CfgInitialize(XAxiDma * InstancePtr, XAxiDma_Config *Config)
{
	...
	if (InstancePtr->HasMm2S) {
		InstancePtr->TxBdRing.ChanBase =
				(u32)BaseAddr + XAXIDMA_TX_OFFSET;
	...
	if (InstancePtr->HasS2Mm) {
		for (Index = 0;
			...
			InstancePtr->RxBdRing[Index].ChanBase =
					(u32)BaseAddr + XAXIDMA_RX_OFFSET;
...
static int XAxiDma_Start(XAxiDma * InstancePtr)
{
	...
	if (!InstancePtr->Initialized) {
		...
		printk("Start: Driver not initialized "
...
int XAxiDma_Pause(XAxiDma * InstancePtr)
{
	...
	if (!InstancePtr->Initialized) {
		...
		printk("Pause: Driver not initialized"
					" %d\r\n",InstancePtr->Initialized);
...
int XAxiDma_Resume(XAxiDma * InstancePtr)
{
	...
	if (!InstancePtr->Initialized) {
		...
		printk("Resume: Driver not initialized"
		" %d\r\n",InstancePtr->Initialized);
...
static int XAxiDma_Started(XAxiDma * InstancePtr)
{
	...
	if (!InstancePtr->Initialized) {
		...
		printk("Started: Driver not initialized"
		" %d\r\n",InstancePtr->Initialized);
