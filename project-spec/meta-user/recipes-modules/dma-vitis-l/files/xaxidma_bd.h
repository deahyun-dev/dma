...
#else
#define XAXIDMA_CACHE_FLUSH(BdPtr) \
	__cpuc_flush_dcache_area((UINTPTR)(BdPtr), XAXIDMA_BD_HW_NUM_BYTES)
	// dma_cache_wback_inv((UINTPTR)(XAXIDMA_VIRT_TO_PHYS(BdPtr)), XAXIDMA_BD_HW_NUM_BYTES)
	
	// Xil_DCacheFlushRange((UINTPTR)(BdPtr), XAXIDMA_BD_HW_NUM_BYTES)

#define XAXIDMA_CACHE_INVALIDATE(BdPtr) \
	__cpuc_flush_dcache_area((UINTPTR)(BdPtr), XAXIDMA_BD_HW_NUM_BYTES)
	// dma_cache_inv((UINTPTR)(XAXIDMA_VIRT_TO_PHYS(BdPtr)), XAXIDMA_BD_HW_NUM_BYTES)
...
#define XAxiDma_BdWrite(BaseAddress, Offset, Data)			\
	(*(u32 *)((u32)(BaseAddress) + (u32)(Offset))) = (u32)(Data)
...
#define XAxiDma_BdGetLength(BdPtr, LengthMask)                \
	(XAxiDma_BdRead((BdPtr), XAXIDMA_BD_CTRL_LEN_OFFSET) & (u32)LengthMask)
