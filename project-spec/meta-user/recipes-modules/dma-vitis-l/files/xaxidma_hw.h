...
#define XAxiDma_ReadReg(BaseAddress, RegOffset)             \
	ioread32((UINTPTR)((u32)(BaseAddress) + (u32)(RegOffset)))
	// (*(u32 *)((u32)(BaseAddress) + (u32)(RegOffset)))
...
#define XAxiDma_WriteReg(BaseAddress, RegOffset, Data)          \
	iowrite32((u32)Data, (UINTPTR)((u32)BaseAddress + (u32)RegOffset))
	// XAxiDma_Out32((BaseAddress) + (RegOffset), (Data))
	// (*(u32 *)((u32)(BaseAddress) + (u32)(RegOffset))) = (u32)(Data)
